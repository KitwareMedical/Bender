...
void qSlicerAppMainWindowPrivate::setupUi(QMainWindow * mainWindow)
{
  ...
  layoutButton->setDefaultAction(this->actionViewLayoutOneUp3D);
...
void qSlicerAppMainWindowPrivate::overwriteSettings()
{
  ...
  this->menuWindowToolBars->menuAction()->setVisible(false);
  this->actionViewLayoutTriple3D->setVisible(false);
  this->actionViewLayoutCompare->setVisible(false);
  this->actionViewLayoutCompareGrid->setVisible(false);
  this->actionViewLayoutCompareWidescreen->setVisible(false);
  this->actionViewLayoutTabbed3D->setVisible(false);
  this->actionViewLayoutTabbedSlice->setVisible(false);
  this->actionViewLayoutTwoOverTwo->setVisible(false);
  this->actionViewLayoutThreeOverThree->setVisible(false);
  this->actionViewLayoutFourOverFour->setVisible(false);
  ...
  // Toolbars
  //this->MainToolBar->removeAction(this->actionFileLoadData);
  //this->MainToolBar->removeAction(this->actionFileSaveScene);
  //this->MainToolBar->addAction(this->actionFileAddVolume);
  //this->MainToolBar->addAction(this->actionFileSaveScene);

  //this->ModuleSelectorToolBar->setVisible(false);
  //this->ModuleToolBar->setVisible(false);
  this->ModuleToolBar->removeAction(this->actionModuleHome);
  ...
  // Icons
  //this->actionFileAddVolume->setIcon(QIcon(":Icons/open.png"));
  //this->actionFileSaveScene->setIcon(QIcon(":Icons/save.png"));
