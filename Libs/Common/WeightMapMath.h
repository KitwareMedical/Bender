...
inline bool Lerp(const WeightMap& weightMap, //weight input
          ...
          WeightMap::WeightVector& w_pi) //output, assumed to be initialized to the vector dimension of the weight map
{
